...
|---|---|---|
| "취소" | 대기/듣기 중 | 조용히 Idle로 복귀 |
| "취소" | 춤/게임 중 | 현재 모드 종료 → Idle 복귀 |
...
| 현재 작업 | 새 이벤트 | 정책 |
|---|---|---|
| 사진 촬영 중 | 모든 새 의도 | **무시** (취소/확인 제외) |
| 사진 촬영 중 | 타이머 만료 | **보류** → 촬영 완료 후 알림 |
| 춤/게임 중 | 모든 새 의도 | **무시** (취소/확인, 타이머 만료 제외) |

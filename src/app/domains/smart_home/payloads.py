...
INTENT_TO_DEVICE_ACTION = {
    ...
    "smarthome.indirect_light.on": ("indirect_light", "on"),
    "smarthome.indirect_light.off": ("indirect_light", "off"),
    "smarthome.robot_cleaner.start": ("robot_cleaner", "start"),
    "smarthome.robot_cleaner.stop": ("robot_cleaner", "stop"),
    "smarthome.air_purifier.on": ("air_purifier", "on"),
    "smarthome.air_purifier.off": ("air_purifier", "off"),
